...
namespace Initializers
{
    public class UserAuthInitializer : DropCreateDatabaseIfModelChanges<DatabaseContext>
    {
        ...
        protected override void Seed(DatabaseContext context)
        {
            ...
            Tuple<string, string> UserAuth3PassAndSalt = _security.GetHashedPasswordAndSaltFrom("123456");
            ...
            Tuple<string, string> UserAuth4PassAndSalt = _security.GetHashedPasswordAndSaltFrom("123456");
            ...
            Tuple<string, string> UserAuth5PassAndSalt = _security.GetHashedPasswordAndSaltFrom("123456");
            ...
            Tuple<string, string> UserAuth6PassAndSalt = _security.GetHashedPasswordAndSaltFrom("123456");
            ...
            Tuple<string, string> UserAuth7PassAndSalt = _security.GetHashedPasswordAndSaltFrom("123456");
            ...
            Tuple<string, string> UserAuth8PassAndSalt = _security.GetHashedPasswordAndSaltFrom("123456");
